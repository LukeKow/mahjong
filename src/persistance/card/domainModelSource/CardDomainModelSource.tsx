        ...
        let cards = new Promise<Array<ICardDomainModel>>((resolve, reject) => {
            setTimeout(() => 
                resolve(new Array<ICardDomainModel>(
                    { id: 0, headsOnTop: false, headsValue: "One", tailsValue: "[x]", playable: true, placedOnBoard: true },
                    { id: 1, headsOnTop: false, headsValue: "Two", tailsValue: "[x]", playable: true, placedOnBoard: true },
                    { id: 2, headsOnTop: false, headsValue: "One", tailsValue: "[x]", playable: true, placedOnBoard: true },
                    { id: 3, headsOnTop: false, headsValue: "Two", tailsValue: "[x]", playable: true, placedOnBoard: true }
                )
            ), 1000);
          });
